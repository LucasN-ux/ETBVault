...
interface SeriesSidebarProps {
  isOpen: boolean
  onClose?: () => void
  /** ETB affichée : son ère est dépliée et sa ligne surlignée. */
...
export default function SeriesSidebar({ isOpen, onClose, currentId }: SeriesSidebarProps) {
  ...
  const estDepliee = (ere: string): boolean => depliees[ere] ?? ere === ereCourante
...
interface LienEtbProps {
  etb: Etb
  actif: boolean
  onClick: () => void
}

function LienEtb({ etb, actif, onClick }: LienEtbProps) {
