...
export interface LigneTicker {
  id: string
  nom: string
  prixActuel: number
  /** Variation 7 jours ; null = pas d'historique. */
  v7: number | null
}
...
export function KPI({ label, value, sub, subColor, mono = true }: KPIProps) {
  return (
    <div>
...
export function EraTag({ children }: EraTagProps) {
  return (
    <span
      className="font-mono"
...
export function Ticker({ items }: { items: readonly LigneTicker[] }) {
