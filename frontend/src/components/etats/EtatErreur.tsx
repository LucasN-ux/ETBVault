...
interface EtatErreurProps {
  erreur: Error | null
  onReessayer?: () => void
  /** Version resserrée, pour un bloc à l'intérieur d'un écran. */
  compact?: boolean
}
...
export default function EtatErreur({ erreur, onReessayer, compact = false }: EtatErreurProps) {
  const reseau = erreur instanceof ApiError && erreur.estReseau
