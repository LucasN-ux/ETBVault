...
const nomDe = (e) => e.nomFr ?? e.nom ?? ''
const dateDe = (e) => new Date(e.dateSortie ?? e.date_sortie ?? 0)
...
function GroupeEre({ groupe, onVoirTout, onOuvrir }) {
...
function filtrer(etbs, ere, recherche) {
  let liste = etbs
